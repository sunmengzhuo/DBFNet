...
def resnet18(num_classes=2, include_top=True):
    return ResNet1(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, include_top=include_top)
...
def resnet101(num_classes=2, include_top=True):
    ...
    return ResNet1(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, include_top=include_top)
...
def resnext50_32x4d(num_classes=2, include_top=True):
    ...
    groups = 32
    width_per_group = 4
    return ResNet1(Bottleneck, [3, 4, 6, 3],
...
def resnext101_32x8d(num_classes=2, include_top=True):
    ...
    groups = 32
    width_per_group = 8
    return ResNet1(Bottleneck, [3, 4, 23, 3],
                  num_classes=num_classes,
                  include_top=include_top,
                  groups=groups,
                  width_per_group=width_per_group)
